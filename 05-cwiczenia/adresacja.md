...
1. Zamieniamy adres na bity.
2. Zamieniamy maskę na bity.
3. Dokonujemy mnożenia binarnego na adresie i masce (AND).

#### Adres rozgłoszeniowy

1. Zamieniamy adres i maskę na bity.
2. Negujemy maskę.
3. Dokonujemy dodawania binernego na adresie i odrwotności maski (OR)
...
* liczba 0 w masce?
- 2^(32-dł. maski)-2 32 bity w adresie, 2 -a.sieci -a.rozgłoszeniowy
- 2^(ilość 0 w masce)-2
